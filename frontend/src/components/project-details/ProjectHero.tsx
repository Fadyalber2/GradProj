      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 lg:p-16 flex items-end">
        <div className="bg-card-dark/60 backdrop-blur-xl p-8 rounded-2xl max-w-2xl w-full border border-white/10">
          ...
          <div className="flex gap-4">
            <button className="bg-primary hover:bg-primary-hover text-white px-6 py-3 rounded-full font-medium transition-all shadow-lg shadow-primary/20 flex items-center gap-2">
              <Download className="h-4 w-4" /> Download Brochure
            </button>
            <button className="bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-full font-medium backdrop-blur-md transition-all border border-white/10 flex items-center gap-2">
