    ...
    >
      ...
      >
        ...
        <div className="relative h-56 overflow-hidden bg-white/5">
          ...
          {/* Top-left: verified + NEW + category */}
        ...
        <div className="p-5">
          <div className="flex justify-between items-start gap-3 mb-3">
            ...
            <div className="text-right shrink-0">
              ...
              {!isForSale && (
                <span className="block text-gray-500 text-[10px] font-normal">/month</span>
              )}
            </div>
          </div>

          {/* Specs row — regular listings */}
          {!isShared && (listing.bedrooms != null || listing.bathrooms != null || listing.property_type) && (
            <div className="flex items-center gap-4 text-gray-400 text-xs mb-3 pb-3 border-b border-white/5">
          ...
          {isShared && (
            <div className="flex items-center justify-between pt-3 border-t border-white/5">
              ...
              <span className="text-[10px] text-gray-500 font-medium uppercase tracking-wider">
                {listing.totalSpots === 1 ? "Private Studio" : `${listing.filledSpots}/${listing.totalSpots} Filled`}
              </span>
            </div>
          )}
        </div>
