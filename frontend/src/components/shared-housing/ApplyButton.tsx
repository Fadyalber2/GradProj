...
export default function ApplyButton({ listing }: Props) {
  ...
  if (sent) {
    return (
      <button
        type="button"
        disabled
        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500/15 px-4 py-3 text-sm font-bold text-emerald-300"
      >
